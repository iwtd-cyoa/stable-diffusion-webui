        ...
        with gr.Tabs(elem_id="tabs_extensions") as tabs:
            ...
            with gr.TabItem("Available"):
                with gr.Row():
                    ...
                    available_extensions_index = gr.Text(value="https://gitgud.io/AUTOMATIC1111/stable-diffusion-webui/-/wikis/Extensions-index.md", label="Extension index URL").style(container=False)
